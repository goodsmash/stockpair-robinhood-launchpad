# StockPair App v0.7.0 agent instructions (Protocol v0.6.0)
...
- The application/indexer version is `0.7.0`; Solidity protocol identifiers remain `STOCKPAIR_*_V0.6.0`. Never change protocol hashes merely to match the app version.
